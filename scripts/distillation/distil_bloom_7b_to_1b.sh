...
# Qwen
BASEMODEL=<YOUR_BLOOM_1B_MODEL_PATH>
TEACHER=./results/teacher/bloom_7b/checkpoint-<YOUR_LAST_CHECKPOINT_STEPS>
STUDENT=$BASEMODEL

OUTDIR=./results/distillation/bloom_7b_to_1b/$LOSS
